...
module Windows
  module Functions
    ...
    attach_function :CreateEvent, [:ptr, :bool, :bool, :str], :handle
    ...
    attach_function :RegisterServiceCtrlHandlerEx, [:str, :handler_ex, :ptr], :handle
    ...
    callback :handler_ex, [:ulong, :ulong, :pt, :pt], :void
